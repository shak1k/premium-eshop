...
use App\Http\Controllers\EshopByShakikController;
...
Route::get('/', [EshopByShakikController::class, 'index'])->name('home');
Route::get('/product-category/{id}', [EshopByShakikController::class, 'category'])->name('product-category');
Route::get('/product-sub-category/{id}', [EshopByShakikController::class, 'subCategory'])->name('product-sub-category');
Route::get('/product-details/{id}', [EshopByShakikController::class, 'details'])->name('product-details');
...
Route::get('/all-product', [EshopByShakikController::class, 'product'])->name('all-product');
