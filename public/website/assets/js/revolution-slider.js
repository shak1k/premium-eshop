        ...
        var i, s, r, n, a, o = function(t) {
            ...
            p = function(i, s, r, n) {
                ...
                this.check = function(l) {
                    ...
                    if (0 === d && r)
                        for (_ = ("com.greensock." + i).split("."), u = _.pop(), m = o(_.join("."))[u] = this.gsClass = r.apply(r, a), n && (e[u] = m, "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + i.split(".").join("https://htmlshopmart.justthemevalley.com/"), [], function() {
                                return m
