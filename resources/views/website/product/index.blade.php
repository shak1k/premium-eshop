            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        ...
                        <li class=""> <a title="Go to Home Page" href="shop_grid.html">Shop</a><span>&raquo;</span></li>
                                            ...
                                            <div class="item-inner h-100">
                                                <div class="product-thumbnail">
                                                    ...
                                                    <div class="pr-img-area"> <a title="{{$product->name}}" href="{{route('product-details', ['id' => $product->id])}}">
                                                            <figure> <img class="first-img" src="{{asset($product->image)}}" alt=""> <img class="hover-img" src="{{asset($product->image)}}" alt=""></figure>
                                                        </a> </div>
                    ...
                    <div class="block-wrapper return">
                        <div class="text-des">
                            ...
                            <div class="service-wrapper">
                                ...
                                <p>Credit Card/ Debit Card/ Banking </p>
                            </div>
                        </div>
                    </div>
                </div>
