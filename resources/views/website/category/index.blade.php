                ...
                <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
                        ...
                        <div class="slider-items-products">
                            <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                                <div class="slider-items slider-width-col1 owl-carousel owl-Template">
                                    ...
                                    <!-- Item -->
                                    <div class="item"> <a href="#x"><img alt="HTML template" src="{{asset('/')}}website/assets/images/cat-slider-img1.jpg"></a>
                                        <div class="inner-info">
                                            <div class="cat-img-title"> <span>Best Product 2023</span>
                                    ...
                                    <!-- Item -->
                                    <div class="item"> <a href="#x"><img alt="HTML template" src="{{asset('/')}}website/assets/images/cat-slider-img2.jpg"></a> </div>
                    ...
                    <div class="shop-inner">
                        <div class="page-title">
                            ...
                            <h2>Showing Products from <b class="text-danger">{{$product->category->name}}</b></h2>
                            @break($product->category->name)
                            @endforeach
                        </div>
                        <div class="toolbar">
                            <div class="view-mode">
                        ...
                        <div class="product-grid-area">
                            <ul class="row">
                                @foreach($products as $product)
                                <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-6 my-2">
                                    <div class="product-item">
                                        <div class="item-inner h-100">
                                            <div class="product-thumbnail">
                                                <div class="icon-new-label new-left">New</div>
                                                <div class="pr-img-area"> <a title="{{$product->name}}" href="{{route('product-details', ['id' => $product->id])}}">
                                                        <figure> <img class="first-img" src="{{asset($product->image)}}" alt="" height="300"> <img class="hover-img" src="{{asset($product->image)}}" alt="" height="400"></figure>
                                                    </a> </div>
                                            ...
                                            <div class="item-info">
                                                <div class="info-inner">
                                                    <div class="item-title"> <a title="{{$product->name}}" href="{{route('product-details', ['id' => $product->id])}}">{{$product->name}}</a> </div>
                                                    <div class="item-content">
                                                        <div class="rating"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> <i class="fa fa-star-o"></i> </div>
                                                        <div class="item-price">
                                                            <div class="price-box"> <span class="regular-price"> <span class="price">{{$product->selling_price}} ৳</span> </span> </div>
                                                        </div>
                ...
                <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
                    ...
                    <div class="block sidebar-cart">
                        ...
                        <div class="block-content">
                            ...
                            <ul>
                                <li class="item"> <a href="shopping_cart.html" title="Sample Product" class="product-image"><img src="{{asset('/')}}website/assets/images/products/product-8.jpg" alt="Sample Product "></a>
                                ...
                                <li class="item last"> <a href="#" title="Sample Product" class="product-image"><img src="{{asset('/')}}website/assets/images/products/product-8.jpg" alt="Sample Product"></a>
                                    <div class="product-details">
                                        <div class="access"> <a href="#" title="Remove This Item" class="remove-cart"><i class="icon-close"></i></a></div>
                    ...
                    <div class="single-img-add sidebar-add-slider ">
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active"> <img src="{{asset('/')}}website/assets/images/add-slide1.jpg" alt="slide1">
                                    <div class="carousel-caption">
                                        <h3><a href="single_product.html" title=" Sample Product">Sale Up to 50% off</a></h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                        <a href="#" class="info">shopping Now</a> </div>
                                </div>
                                <div class="item"> <img src="{{asset('/')}}website/assets/images/add-slide2.jpg" alt="slide2">
                                    <div class="carousel-caption">
                                        <h3><a href="single_product.html" title=" Sample Product">Smartwatch Collection</a></h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                        <a href="#" class="info">All Collection</a> </div>
                                </div>
                                <div class="item"> <img src="{{asset('/')}}website/assets/images/add-slide3.jpg" alt="slide3">
                                    <div class="carousel-caption">
                    ...
                    <div class="block special-product">
                        ...
                        <div class="block-content">
                            <ul>
                                <li class="item">
                                    <div class="products-block-left"> <a href="single_product.html" title="Sample Product" class="product-image"><img src="{{asset('/')}}website/assets/images/products/product-1.jpg" alt="Sample Product "></a></div>
                                ...
                                <li class="item">
                                    <div class="products-block-left"> <a href="single_product.html" title="Sample Product" class="product-image"><img src="{{asset('/')}}website/assets/images/products/product-2.jpg" alt="Sample Product "></a></div>
                                    <div class="products-block-right">
                    ...
                    <div class="offer-banner"><img src="{{asset('/')}}website/assets/images/offer-banner.jpg" alt="banner"></div>
                </aside>
            </div>
        </div>
    </div>
