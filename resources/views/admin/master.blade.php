...
<head>
    ...
    <!-- TITLE -->
    <title>SHAKiK'z eShop - Admin Panel</title>
            ...
            <div class="container-fluid main-container">
                <div class="d-flex">
                    ...
                    <a class="logo-horizontal" href="#">
                        <img src="{{asset('/')}}admin/assets/images/brand/green-logo.png" class="header-brand-img desktop-logo" alt="logo">
                        <img src="{{asset('/')}}admin/assets/images/brand/red-logo.png.png" class="header-brand-img light-logo1"
                             alt="logo">
                    </a>
                    <!-- LOGO -->
                                ...
                                <div class="d-flex order-lg-2">
                                    ...
                                    <div class="dropdown d-md-flex profile-1">
                                        <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
												<span>
													<img src="{{asset('/')}}admin/assets/images/faces/SHAKiK_pic.jpg" alt="profile-user"
                                                         class="avatar  profile-user brround cover-image">
												</span>
                                            <div class="text-center p-1 d-flex d-lg-none-max">
                                                <h6 class="mb-0" id="profile-heading">Shakik Prodhan<i class="user-angle ms-1 fa fa-angle-down "></i></h6>
                                            </div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
            ...
            <div class="app-sidebar">
                <div class="side-header">
                    <a class="header-brand1" href="#">
                        <img src="{{asset('/')}}admin/assets/images/brand/main-logo.png" class="header-brand-img desktop-logo" alt="logo">
                        <img src="{{asset('/')}}admin/assets/images/brand/red-logo.png" class="header-brand-img toggle-logo" alt="logo">
                        <img src="{{asset('/')}}admin/assets/images/brand/logo_i.png" class="header-brand-img light-logo" alt="logo">
                        <img src="{{asset('/')}}admin/assets/images/brand/logo_ii.png" class="header-brand-img light-logo1" alt="logo">
                    </a><!-- LOGO -->
                </div>
...
{{--                                <span class="side-menu__label">Setting Module</span><i class="angle fa fa-angle-right"></i></a>--}}
{{--                            <ul class="slide-menu">--}}
        ...
        <div class="container">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-md-12 col-sm-12 text-center">
                    Copyright © 2023 <a href="{{route('home')}}" target="_blank">SHAKiK'z eShop</a> | Developed with <span class="fa fa-heart text-danger"></span> by <a href="https://fb.me/shak1k" target="_blank"> Shakik Prodhan | </a> All rights reserved.
                </div>
            </div>
        </div>
    </footer>
    ...
    function getSubCategoryByCategory(categoryId) {
        $.ajax({
            ...
            success: function (response) {
                var option = '';
                option += '<option>--Select Product Sub Category--</option> ';
