        ...
        <div class="col-lg-12">
            <div class="invoice-box">
                <table cellpadding="0" cellspacing="0">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        SHAKiK'z Premium eShop<br />
                                        Abu Hasnat Md. Shakik Prodhan<br />
                                        bd.shakik@gmail.com
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr class="total">
                        <td colspan="2"></td>
                        <td colspan="2">Order Total: {{$sum}} ৳</td>
                    </tr>
                    <tr class="total">
                        <td colspan="2"></td>
                        <td colspan="2">Tax Total (15%): {{$order->tax_total}} ৳</td>
                    </tr>
                    <tr class="total">
                        <td colspan="2"></td>
                        <td colspan="2">Shipping Total: {{$order->shipping_total}} ৳</td>
                    </tr>
                    <tr class="total">
                        <td colspan="1"></td>
