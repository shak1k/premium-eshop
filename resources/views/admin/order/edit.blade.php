            ...
            <div class="card card-body">
               <form action="{{route('admin.order-update', ['id' => $order->id])}}" method="POST">
                   ...
                   <div class="row mb-3">
                       ...
                       <div class="col-md-9">
                           <input type="text" value="{{$order->id}}" readonly class="form-control"/>
                       </div>
                   </div>
                   <div class="row mb-3">
                       <label class="col-md-3">Order Date</label>
                       <div class="col-md-9">
                           <input type="text" value="{{$order->order_date}}" readonly class="form-control"/>
                       </div>
                   </div>
                   <div class="row mb-3">
                   ...
                   <div class="row mb-3">
                       ...
                       <div class="col-md-9">
                           <select class="form-control" name="delivery_media">
                               <option value=""> -- Select Order Delivery Media -- </option>
