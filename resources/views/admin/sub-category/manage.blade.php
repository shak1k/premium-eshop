                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap border-bottom w-100" id="responsive-datatable">
                            ...
                            <tr>
                                ...
                                <th class="wd-20p border-bottom-0">Sub Category Name</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('sub-category.delete', ['id' => $sub_category->id])}}" onclick="return confirm('Are you sure you want to delete this?')" class="btn btn-danger btn-sm">
