            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('sub-category.update', ['id' => $sub_category->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            <label for="firstName" class="col-md-3 form-label">Add Sub Category Name</label>
                            <div class="col-md-9">
                                <input class="form-control" id="firstName" value="{{$sub_category->name}}" placeholder="Sub Category Name" name="name" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
