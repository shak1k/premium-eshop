                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="productName" placeholder="Product Name" name="name" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" placeholder="Product Code" name="code" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Product Reorder Amount" name="reorder_label"/>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
